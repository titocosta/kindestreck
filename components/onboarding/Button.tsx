...
import { onboarding as theme } from '@/constants/Colors';
...
export function Button({
  ...
  const handleNextScreen = () => {
    ...
    if (!isLastScreen) {
      ...
      console.debug(`[Button] Last screen reached`);
      localSave('onboarded', true);
      router.push('/login');
    }
  };

  console.debug(`[Button] Rendering onboarding screen ${flatListIndex.value} of ${dataLength}`);
  ...
  return (
    ...
    >
      ...
      <Animated.Text style={[styles.text, arrowAnimationStyle]}>
        Next
      </Animated.Text>
  ...
  /*
    // Replaced arrow with "Next" due to a bug with Animated and SVG icons
    return (
      <AnimatedPressable
        onPress={handleNextScreen}
        style={[styles.container, buttonAnimationStyle]}
